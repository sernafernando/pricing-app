...
export function useTiendaKeyboard({
  ...
  }, [pricing.editandoPrecio, pricing.editandoRebate, pricing.editandoWebTransf, pricing.editandoCuota, data.productos, celdaActiva, showToast, API_URL, pricing, data]);
