...
export default function TabRentabilidadTiendaNube({ fechaDesde, fechaHasta, vendedoresSeleccionados = [], puedeVerGanancia = true }) {
        ...
        <>
          ...
          <div className={styles.totalCard}>
            <div className={styles.totalHeader}>
              <h3>Total del período (Tienda Nube)</h3>
            ...
            <div className={styles.totalGrid}>
              ...
              <div className={styles.totalItem}>
                <span className={styles.totalLabel}>Comisión TN ({rentabilidad.filtros_aplicados?.comision_tn_porcentaje || 1}%)</span>
                <span className={styles.totalValor} style={{ color: '#f59e0b' }}>{formatMoney(rentabilidad.totales.comision_tn)}</span>
              </div>
              <div className={styles.totalItem}>
                <span className={styles.totalLabel}>Monto Limpio</span>
            ...
            {rentabilidad.cards.map((card, index) => (
              ...
              >
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardMetrica}>
                    <span>Comisión TN:</span>
                    <span style={{ color: '#f59e0b' }}>{formatMoney(card.comision_tn)}</span>
                  </div>
                  <div className={styles.cardMetrica}>
                    <span>Monto Limpio:</span>
