...
^FO30,460^A0N,24,24^FDCP: {{CP_CLIENTE}}^FS
^FO250,460^A0N,24,24^FDCiudad: {{CIUDAD_CLIENTE}}^FS

^FO30,500^A0N,24,24^FH^FDTel: {{TELEFONO_DESTINATARIO}}^FS

^FO0,540^GB800,2,2^FS

^FX ═══════════════════════════════════════════════════════
^FX   DETALLE DE ENVÍO
^FX ═══════════════════════════════════════════════════════

^FO30,560^A0N,24,24^FDPedido: {{ID_PEDIDO}}^FS
^FO300,560^A0N,24,24^FDItems: {{CANTIDAD_ITEMS}}^FS

^FO30,600^A0N,24,24^FB750,2,0,L^FDSKU: {{SKUS_CONCATENADOS}}^FS

^FO30,660^A0N,24,24^FB750,3,0,L^FH^FDObs: {{OBSERVACIONES}}^FS

^FO0,740^GB800,2,2^FS

^FX — Bultos (grande, centrado) —
^FO0,760^A0N,70,70^FB800,1,0,C^FD{{TOTAL_BULTOS}} BULTO{{BULTOS_PLURAL}}^FS

^FX — Logística que lo lleva —
^FO0,850^A0N,24,24^FB800,1,0,C^FH^FDLog_C3_ADstica: {{LOGISTICA_NOMBRE}}^FS

^FX — Pie —
^FO0,900^GB800,2,2^FS
^FO0,920^A0N,20,20^FB800,1,0,C^FDGauss Online - Felipe Vallese 1559 - CP 1406 - Tel: (11) 5263-0601^FS
