...
async def agregar_a_banlist(
    ...
    # Crear registro
    banlist_item = ProduccionBanlist(item_id=request.item_id, motivo=request.motivo, usuario_id=current_user.id)
...
async def marcar_prearmado(
    ...
    prearmado_item = ProduccionPrearmado(item_id=item_id, cantidad=request.cantidad, usuario_id=current_user.id)
