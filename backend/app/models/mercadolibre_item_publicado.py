from sqlalchemy import Column, Integer, BigInteger, String, Boolean, DateTime, Numeric, Text, Date
...
class MercadoLibreItemPublicado(Base):
    ...
    mlp_blockCatalogPriceUpdateFromNormalPublication = Column('mlp_blockcatalogpriceupdatefromnormalpublication', Boolean, default=False)
    ...
    mlp_lastPublicatedPriceOrExchangeChanged = Column('mlp_lastpublicatedpriceorexchangechanged', Boolean, default=False)
