...
class MlOrdersOps(Base):
    ...
    __table_args__ = (
        ...
        # Created by migration 20260922_ml_order_metrics (a plain CREATE
        # INDEX: it briefly blocks writes to this table while it builds) for
        # the seller + date scope of the sales queries.
