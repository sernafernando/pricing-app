...
class NotificacionIgnorada(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "item_id", "tipo", "markup_real", name="uq_notificacion_ignorada"),)
    ...
    def __repr__(self):
        return (
            f"<NotificacionIgnorada user={self.user_id} item={self.item_id} tipo={self.tipo} markup={self.markup_real}>"
        )
