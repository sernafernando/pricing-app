...
class SectorConfiguracionAsignacion(BaseModel):
    ...
    tipo: str = Field(default="round_robin", description="Tipo de estrategia: round_robin, basado_en_carga, basado_en_skills, manual")
...
class SectorConfiguracionNotificaciones(BaseModel):
    ...
    destinatarios_default: List[int] = Field(default_factory=list, description="IDs de usuarios que siempre reciben notificaciones")
...
class SectorBase(BaseModel):
    ...
    configuracion: SectorConfiguracion = Field(default_factory=SectorConfiguracion, description="Configuración del sector")
