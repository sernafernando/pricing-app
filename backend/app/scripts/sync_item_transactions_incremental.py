        ...
        for item_json in items_data:
            try:
                ...
                item = ItemTransaction(
                    ...
                    it_packinginvoicepend=to_bool(item_json.get("it_packingInvoicePend")),
                    ...
                    it_packinginvoiceselected=to_bool(item_json.get("it_packingInvoiceSelected")),
                    ...
                    it_deliverycharge=to_bool(item_json.get("it_deliveryCharge")),
