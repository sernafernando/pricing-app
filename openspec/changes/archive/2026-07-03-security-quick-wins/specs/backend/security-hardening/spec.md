# Spec Delta: Security Quick Wins

> Change: `security-quick-wins`
> Backend: FastAPI + SQLAlchemy. This delta describes WHAT must be true after
> the change lands. It does not prescribe implementation shape (see `design`).
