# Spec: frontend/rrhh-horas-extras

**Capability**: `frontend/rrhh-horas-extras`
**Status**: Active (canonical source of truth)
**Origen**: Sincronizado desde `openspec/changes/archive/2026-04-30-rrhh-horas-extras/specs/frontend/rrhh-horas-extras/spec.md`
**Última actualización**: 2026-04-30

> Página `RRHHHorasExtras.jsx` con cinco tabs (Pendientes/Aprobadas/Liquidadas/Anomalías/Alertas), modales de detalle/aprobación/liquidación/recalcular/completar-fichada, integración con `RRHHSueldos.jsx` y permisos diferenciados. Incluye los fixes de Revisión 1 (tabs Anomalías y Alertas, completar fichada / descartar día / reabrir bloque).
